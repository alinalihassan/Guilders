...
- **Automatic syncing** — Connect institutions via EnableBanking (open banking), SnapTrade (brokerages), Teller, and Lunch Flow (personal API key), with more providers on the way
