		...
		<section id="features" className="container mx-auto px-4 py-24 md:py-32">
			<div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
				...
				<p className="text-xl text-muted-foreground">
					A deeply opinionated take on personal finance, designed for speed,
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
				...
				>
					...
					<div className="p-8 md:p-10 flex flex-col h-full relative z-10">
						...
						<p className="text-muted-foreground text-lg max-w-md">
							Stop digging through spreadsheets. Ask complex questions about
							your spending, find hidden subscriptions, and get actionable
							insights instantly.
						</p>
								...
								<div className="flex gap-3 self-end flex-row-reverse">
									...
									<div className="bg-accent/10 px-4 py-3 rounded-2xl rounded-tr-sm border border-accent/20 max-w-[80%]">
										<div className="text-sm mb-3">
											You spent{" "}
											<strong className="text-foreground">$450.20</strong> on
											dining out this month. That&apos;s{" "}
											<strong className="text-primary">12% less</strong> than
											last month! 🎉
										</div>
				...
				>
					...
					<div className="p-8 md:p-10 flex flex-col h-full relative z-10">
						...
						<p className="text-muted-foreground">
							Connect your banks, credit cards, and brokerages. Transactions
						...
						<div className="mt-8 flex-1 flex flex-col justify-end">
							<div className="space-y-3">
								{[1, 2, 3].map((i) => (
									<div
										key={i}
										className="h-12 w-full rounded-xl bg-background/50 border border-border/50 flex items-center px-4 relative overflow-hidden"
									>
				...
				>
					...
					<div className="p-8 md:p-10 flex flex-col h-full relative z-10">
						...
						<p className="text-muted-foreground">
							We don&apos;t harvest or sell your data. Fully open-source.
							Inspect the code or host it yourself via Docker.
						</p>
					...
					<div className="p-8 md:p-10 flex flex-col md:flex-row gap-8 h-full relative z-10 items-center">
						<div className="flex-1">
							...
							<p className="text-muted-foreground text-lg">
								Understand your cash flow velocity. Project your net worth years
								into the future based on current spending and investment habits.
							</p>
						</div>
						<div className="flex-1 w-full max-w-[300px] h-[200px] relative">
							<svg
								className="w-full h-full text-emerald-500 drop-shadow-[0_0_12px_rgba(16,185,129,0.6)]"
								viewBox="0 0 100 100"
