...
export default defineConfig({
  ...
  define: {
    ...
    "process.env.STRIPE_SECRET_KEY": JSON.stringify("sk_test_placeholder"),
    "process.env.STRIPE_PRO_PRICE_ID": JSON.stringify("price_test_placeholder"),
    "process.env.STRIPE_WEBHOOK_SECRET": JSON.stringify("whsec_test_placeholder"),
    "process.env.RESEND_API_KEY": JSON.stringify("re_test_placeholder"),
