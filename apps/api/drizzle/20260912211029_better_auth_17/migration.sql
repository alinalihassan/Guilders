...
ALTER TABLE "user_account" ADD COLUMN "issuer" text;--> statement-breakpoint
...
CREATE UNIQUE INDEX "user_account_issuer_accountId_uidx" ON "user_account" ("issuer","account_id");--> statement-breakpoint
