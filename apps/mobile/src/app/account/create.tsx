        ...
        {ACCOUNT_SUBTYPES.map((subtype) => (
          <Pressable
            ...
            style={({ pressed }) => ({
              ...
              paddingVertical: Spacing.two,
              paddingHorizontal: Spacing.three,
              backgroundColor: selected === subtype.value ? colors.text : colors.backgroundElement,
              borderRadius: 24,
          ...
          >
            ...
            <Text
              style={{
                ...
                color: selected === subtype.value ? colors.background : colors.text,
              }}
            >
              {subtype.label}
            </Text>
...
export default function CreateAccountScreen() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    if (!formData.value.trim() || Number.isNaN(parseFloat(formData.value))) {
